...
#----------------------------------------------------------
   ...
   @cherrypy.expose
   #-------------------------------------------------------
   def save(self, id_spa, name1_spa,name2_spa, vorname1_spa,vorname2_spa, matrnr1_spa,matrnr2_spa):
   #-------------------------------------------------------
      id_s = id_spa
      data_a = [ name1_spa,name2_spa, vorname1_spa,vorname2_spa, matrnr1_spa,matrnr2_spa ]
      if id_s != "None":
